...
//
// If 0 new tickers (promo, parse fail, all dupes) → nothing is marked.
// Non-fatal: label failures are logged; the DB write already completed.
//
...
export default defineComponent({
  ...
  async run({ steps, $ }) {
    ...
    // Gmail modify requires a label ID, not the name. We look it up once per
    // run and create it on first use.
